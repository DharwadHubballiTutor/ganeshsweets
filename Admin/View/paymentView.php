    ...
    <form name="payments" method="POST" id="itemListForm" enctype="multipart/form-data" action="">
        <div class="form-group">
            <div class="row">
                ...
                <?php 
                    if($saleOrder!=null){
                    echo  "<input type='hidden' id='salesOrderNumber' value=".$saleOrder->get_Id()."/>"; 
                    }
                    ?>
            </div>
        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" name="SOcode" id="SOcode" class="form-control"
                                                    ...
                                                    data-parsley-maxlength="150" data-parsley-trigger="keyup" disabled
                                                    value="<?php if($saleOrder!=null) { echo  $saleOrder->getSOCode(); }  ?>" />
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" name="totalamt" id="totalamt" class="form-control"
                                                    ...
                                                    value="<?php if($saleOrder!=null){  echo  $saleOrder->get_totalAmount(); } ?>" readonly />
                                            </div>
                                        </div>
                                        <br />
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-sm-12">
                                                <textarea type="text" id="paymentdescription" name="paymentdescription"
                                                    placeholder="Payment Comments" class="form-control"
                                                    required></textarea>
                                            </div>
                                        </div>
                                        <br />
...
$(document).ready(function() {
    ...
    $('#itemListForm').submit(function(e) {
        ...
        var fileName = $('#salesordercode').text() + '_SO';
